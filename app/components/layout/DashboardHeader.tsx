...
export default function DashboardHeader({
  ...
  return (
    <>
      <header className="sticky top-0 z-[80] flex h-16 w-full items-center justify-between border-b border-slate-200 bg-white/80 px-4 backdrop-blur-md dark:border-slate-800 dark:bg-black/80 md:hidden">
