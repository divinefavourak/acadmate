    ...
    <div className="flex flex-col min-h-screen bg-[#09090b] text-white relative overflow-hidden">
      ...
      <header className="sticky top-0 z-50 border-b border-white/5 bg-[#09090b]/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-4 md:px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-400" aria-label="Main navigation">
          ...
          >
            <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl shadow-black/40 aspect-4/3">
              <Image
                ...
                alt="Nigerian students taking JAMB CBT exam in a computer lab"
                fill
            ...
            >
              <Image
                ...
                alt="Nigerian student studying and practising for JAMB"
                width={208}
                height={156}
        ...
        >
          ...
          <motion.div variants={fadeUp} className="bg-white/3 border border-white/8 rounded-2xl p-8 space-y-6">
            <div>
              ...
              <p className="text-slate-400 text-sm mt-2">Start practising instantly, no card needed.</p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <div className="relative aspect-4/3 rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
              <Image
                src="/images/520596414_739489019062965_5923685459460735498_n.jpg"
                alt="Students studying literature in a Nigerian exam hall"
                fill
                className="object-cover"
                sizes="(max-width: 1024px) 100vw, 50vw"
              />
      ...
      {recentPosts.length > 0 && (
        <section className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 py-20 md:py-24">
          <motion.div
            variants={fadeUp}
            initial="hidden"
            whileInView="visible"
          ...
          >
            <div className="flex items-end justify-between mb-10">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.18em] text-indigo-400 mb-2">The Acadmate Blog</p>
                <h2 className="text-3xl md:text-4xl font-bold">News, tips &amp; opportunities</h2>
              </div>
              <Link href="/blog" className="hidden sm:inline-flex text-sm font-medium text-indigo-400 hover:text-indigo-300 transition-colors">
                View all posts →
              </Link>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              {recentPosts.map((post) => (
                <Link
                  key={post.id}
                  href={`/blog/${post.slug}`}
                  className="group rounded-2xl overflow-hidden border border-white/8 bg-white/3 hover:border-indigo-500/30 hover:bg-white/6 transition-all flex flex-col"
                >
                  <div className="aspect-video bg-slate-900 relative overflow-hidden">
                    {post.coverImageUrl ? (
                      ...
                      <div className="w-full h-full bg-gradient-to-br from-indigo-600/20 to-purple-600/10" />
                    )}
                  </div>
                  <div className="p-5 flex-1 flex flex-col gap-2">
                    ...
                    <h3 className="font-bold leading-snug text-slate-200 group-hover:text-white transition-colors">
                      {post.title}
                    </h3>
            ...
            <div className="mt-8 text-center sm:hidden">
              <Link href="/blog" className="text-sm font-medium text-indigo-400 hover:text-indigo-300 transition-colors">
                View all posts →
              </Link>
            </div>
          </motion.div>
      ...
      <section id="demo" className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 py-16 mb-20">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="mt-6 text-indigo-300 text-sm">Free to start — no credit card required.</p>
          </div>
        </motion.div>
      </section>
      ...
      <footer className="relative z-10 border-t border-white/5 py-10 px-4 md:px-6 bg-[#09090b]/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-col items-center md:items-end gap-3 text-sm">
            <nav className="flex gap-4 text-slate-500 text-xs" aria-label="Legal">
