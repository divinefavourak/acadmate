    ...
    <div className="flex flex-col min-h-screen bg-[#09090b] text-white relative overflow-hidden">
      ...
      <header className="sticky top-0 z-50 border-b border-white/5 bg-[#09090b]/80 backdrop-blur-xl">
        <div className="max-w-6xl mx-auto px-4 md:px-6 h-16 flex items-center justify-between">
          ...
          <Link href="/register" className="text-sm font-semibold bg-indigo-600 hover:bg-indigo-500 text-white px-4 py-2 rounded-xl transition-colors">
            Get started
          </Link>
        </div>
      </header>
      ...
      <footer className="relative z-10 border-t border-white/5 py-6 mt-12 text-center text-xs text-slate-500">
